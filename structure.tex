%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Metrasens Technical Document Format
% Based on Wenneker Article
% LaTeX Template
...
% Vel (vel@LaTeXTemplates.com) [Wenneker]
% Frits Wenneker [Wenneker]
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Headers
\lhead{} % Left header
\chead{\textit{\thetitle \ -- Metrasens Proprietary}} % Center header - article title and proprietary label
\rhead{} % Right header

% Footers
\lfoot{} % Left footer
\cfoot{Commercial in Confidence $|$ \copyright \ Metrasens Ltd. 2022} % Center footer, shows disclaimer
...
\newcommand{\metdisclaimer}[1]{{\usefont{OT1}{phv}{m}{sl}\color{Black}#1}} % Disclaimer style (Helvetica)

\usepackage{titling} % Allows custom title configuration

\newcommand{\HorRule}{\color{metorange}\rule{\linewidth}{2pt}} % Defines the metrasens orange horizontal rule around the title
