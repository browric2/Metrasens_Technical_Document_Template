...
\title{Metrasens Scientific / Technical Article Template} % The article title

\author{
	\authorstyle{Richard Hodgskin-Brown} % Authors
	\newline\newline % Space before disclaimer
...
\begin{figure}
	...
	\caption{Point dipole field pattern.} % Figure caption
	\label{Dipole} % Label for referencing with \ref{Dipole}
\end{figure}
